...
const prepare = async function (thisObject, contracts) {
...
const deploy = async function (thisObject, contracts) {
    for (let i in contracts) {
        let contract = contracts[i];
...
const createSLP = async function (thisObject, name, tokenA, tokenB, amount) {
...
const getBigNumber = function (amount, decimals = 18) {
